...
# Install the debug APK (com.wrait.app.debug) alongside the release app
# (com.wrait.app) without touching the release package or its data.
adb -s 4A181FDJH0030G install -r app/build/outputs/apk/debug/app-debug.apk
